...
$sql_list = "SELECT * FROM homestays WHERE $where_clause ORDER BY homestays_id DESC";
    ...
    <header class="sticky top-0 z-50 bg-white/95 backdrop-blur shadow-sm border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
            ...
            <nav class="hidden md:flex gap-8 font-medium text-gray-600">
                ...
                <a href="kham_pha.php" class="text-[#13ecc8] font-bold">Khám phá</a>
            ...
            <div class="flex items-center gap-4">
                <?php if(isset($_SESSION['fullname'])): ?>
                    <div class="flex items-center gap-3">
                        <span class="text-sm font-medium hidden sm:block">Hi, <b><?php echo htmlspecialchars($_SESSION['fullname']); ?></b></span>
        ...
        <div class="mb-12">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="kham_pha.php?district=Tây Hồ" class="relative h-40 rounded-xl overflow-hidden group cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Tây Hồ">
                ...
                <a href="kham_pha.php?district=Ba Vì" class="relative h-40 rounded-xl overflow-hidden group cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1623129372134-29cb67c427c3?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Ba Vì">
                    <div class="absolute inset-0 bg-black/30 group-hover:bg-black/40 transition"></div>
                ...
                <a href="kham_pha.php?district=Sóc Sơn" class="relative h-40 rounded-xl overflow-hidden group cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Sóc Sơn">
                    <div class="absolute inset-0 bg-black/30 group-hover:bg-black/40 transition"></div>
                ...
                <a href="kham_pha.php?district=Hoàn Kiếm" class="relative h-40 rounded-xl overflow-hidden group cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1555921015-5532091f6026?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Hoàn Kiếm">
                    <div class="absolute inset-0 bg-black/30 group-hover:bg-black/40 transition"></div>
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-3 mb-8 overflow-x-auto pb-2 scrollbar-hide">
                ...
                foreach($districts as $d) {
                    ...
                    $link = ($d == "Tất cả") ? "kham_pha.php" : "kham_pha.php?district=" . urlencode($d);
                    
                    echo "<a href='$link' class='px-5 py-2.5 rounded-full text-sm font-bold border transition shadow-sm whitespace-nowrap $activeClass'>" . htmlspecialchars($d) . "</a>";
                }
                ?>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm hover:shadow-lg transition overflow-hidden group">
                    <a href="chi_tiet_home.php?homestay_id=<?php echo $row['homestay_id']; ?>">
                        <div class="relative h-60 overflow-hidden">
                            <img src="uploads/<?php echo htmlspecialchars($row['main_image']); ?>" 
                            ...
                            <div class="absolute bottom-3 left-3 bg-[#13ecc8] text-white text-[10px] font-bold px-2 py-1 rounded">
                                View <?php echo htmlspecialchars($row['district']); ?>
                            </div>
                        </div>
                        <div class="p-4">
                            <h3 class="font-bold text-gray-900 truncate mb-1"><?php echo htmlspecialchars($row['name']); ?></h3>
